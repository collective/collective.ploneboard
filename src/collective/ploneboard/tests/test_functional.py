...
testfiles = [
    '../../../../README.rst',
    'functional_test_ploneboard_messageboard_workflow.txt',
    'functional_test_ploneboard_conversation_without_review_workflow.txt',
    'functional_test_ploneboard_conversation_workflow.txt',
]
